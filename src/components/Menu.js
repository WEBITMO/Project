    ...
    return (
        <AppBar position="static">
            <Toolbar>
                ...
                <Button color="inherit" component={Link} to="/image">Классификация изображения</Button>
                <Button color="inherit" component={Link} to="/image_segmentation">Сегментация изображения</Button>
